                ...
                <div className="content">
                    <Card className="edit-note">
                        <Form onSubmit={this.handleSubmit} style={{width: "100%", justifyContent: "center"}}>
                            <Form.Item>
                                <h2> Create Category</h2> <Button> <NavLink to="/admin/category" style={{color: 'purple'}}><Icon type="caret-left" /> Go Back </NavLink></Button>
                            </Form.Item>
                            <Form.Item>
                            ...
                            <Form.Item>
                                <Button type="primary" htmlType="submit" style={{width: "100%"}}>Create Category</Button>    
                            </Form.Item>
                        </Form>
                    </Card>
...
export default withRouter(Form.create()(CreateCategory));